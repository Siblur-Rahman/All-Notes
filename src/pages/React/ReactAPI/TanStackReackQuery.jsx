...
const TanStackReackQuery = () => {
    return (
        <div>
            ...
            code={`
TanStack Query ডেটা ফেচিং এবং সিঙ্ক্রোনাইজেশনের জন্য একটি জনপ্রিয় লাইব্রেরি। এর মধ্যে "mutation" একটি গুরুত্বপূর্ণ কনসেপ্ট যা মূলত সার্ভার ডেটা পরিবর্তনের জন্য ব্যবহৃত হয়।
Mutation-এর কাজ:
- ডেটা পরিবর্তন করা: যেকোনো ক্রিয়াকলাপ যা ডেটা পরিবর্তন করে যেমন তৈরি করা, আপডেট করা বা ডিলিট করা, তা mutation দ্বারা করা হয়।
- অপ্টিমিস্টিক আপডেট: ক্লায়েন্ট সাইডে ইন্সট্যান্ট আপডেট দেখানো হয়, ফলে ইউজার ইন্টারফেস তাৎক্ষণিক প্রতিক্রিয়া দেয়।
- অটোমেটিক রিফ্রেশ: যখন mutation সফলভাবে সম্পন্ন হয়, তখন সংশ্লিষ্ট query গুলো অটোমেটিক রিফ্রেশ হয় যাতে ইউজার সবসময় আপডেটেড ডেটা দেখতে পায়।
...
এখানে, useMutation হুকটি ব্যবহৃত হয়েছে updateData ফাংশনকে মিউটেশন হিসেবে ব্যবহারের জন্য। mutation.mutate ফাংশনটি ট্রিগার করলে ডেটা আপডেট হবে এবং সফল হলে সংশ্লিষ্ট query গুলো রিফ্রেশ হবে।
এইভাবে, TanStack Query-তে মিউটেশন ব্যবহার করে আপনি সার্ভার সাইড ডেটা ম্যানিপুলেশন করতে পারবেন এবং ইউজার ইন্টারফেসে তাৎক্ষণিক ফিডব্যাক দিতে পারবেন।
            `}
            />
            <Blog
